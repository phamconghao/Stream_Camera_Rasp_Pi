...
// Full session lookup, used by rtsp_server.cpp's handle_play() to
// fetch the client_ip/client_rtp_port a PLAYING session's RTP
// destination should be added to udp_sender under.
